...
def genlisthtml(print):
    assert os.path.basename(os.getcwd()) != "preview" and os.path.exists(
        "./preview"
    ...
    for iconcategory in iconcategories:
        ...
        def outputIconDivs(pathprefix):
            ...
            originalpngs = [
                ...
                for filename in glob.glob(originalpngpath + "*.png")
            ]
            for matchingsvg in svgbasenames:
                originalpng = matchingsvg.replace(".svg", ".png")
                if originalpng in originalpngs:
                    imagehtml = '<img src="{0}" class="originalcomparison" />'.format(
                        "../" + originalpngpath + originalpng
                    )
                else:
                    imagehtml = ""
                ...
                print(
                    ...
                    <div class=\"iconcontainer\">
                        ...
                        pathprefix + matchingsvg, matchingsvg, imagehtml
                    )
                )
